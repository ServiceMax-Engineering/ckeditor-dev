...
* [#2395](https://github.com/ckeditor/ckeditor-dev/issues/2395) Fixed: focused input in [dialog](https://ckeditor.com/cke4/addon/dialog) is scrolled out of the viewport when soft keyboard appears.
